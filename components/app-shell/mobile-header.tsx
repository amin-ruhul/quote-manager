...
export function MobileHeader({
  ...
  return (
    <header className="sticky top-0 z-20 flex items-center gap-2 bg-canvas/85 px-4 py-2 pt-[calc(0.5rem+env(safe-area-inset-top))] shadow-nav backdrop-blur lg:hidden">
